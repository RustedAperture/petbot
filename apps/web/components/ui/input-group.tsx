...
function InputGroupButton({
  ...
  VariantProps<typeof inputGroupButtonVariants> & {
    ...
    // allow caller to override if necessary, but default true because
    // controls rendered inside an input group almost always need native
    // semantics. Without this Base UI warns when `render` prop returns a
    // <button> (e.g. ComboboxTrigger).

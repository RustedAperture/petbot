...
CREATE TABLE `__new_SequelizeMeta` (
	`name` text PRIMARY KEY
);
--> statement-breakpoint
INSERT INTO `__new_SequelizeMeta`(`name`) SELECT `name` FROM `SequelizeMeta`;--> statement-breakpoint
DROP TABLE `SequelizeMeta`;--> statement-breakpoint
ALTER TABLE `__new_SequelizeMeta` RENAME TO `SequelizeMeta`;--> statement-breakpoint
